...
namespace GenericApi.Model.Migrations
{
    ...
    [Migration("20210819182741_LastMigration")]
            ...
            modelBuilder.Entity("GenericApi.Model.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 8, 19, 18, 27, 41, 349, DateTimeKind.Unspecified).AddTicks(4501), new TimeSpan(0, 0, 0, 0, 0)),
                            Deleted = false,
                            Dob = new DateTime(2021, 8, 20, 2, 27, 41, 349, DateTimeKind.Local).AddTicks(4941),
                            DocumentType = 0,
